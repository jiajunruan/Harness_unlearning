...
This audit reads the three conditions on 100 retain and 100 forget tasks each from `/users/2/jruan/Stable_evolving/outputs/full_react_3way_luna_p0`. It does not rerun inference or judging and does not change published counts or evaluation code. Run `python evaluation_audit/audit_rates.py` to reproduce the counts.
